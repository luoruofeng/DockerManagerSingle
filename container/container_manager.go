...
type ContainerManager interface {
	...
	BashContainerWithCmds(id string, cmds []string) (*dockertypes.HijackedResponse, error)
}
...
func (cm *containerManager) BashContainer(id string) (*dockertypes.HijackedResponse, error) {
	return cm.BashContainerWithCmds(id, []string{"sh"})
}

func (cm *containerManager) BashContainerWithCmds(id string, cmds []string) (*dockertypes.HijackedResponse, error) {
